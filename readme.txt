...
Don't see one on the list, or want to make sure one plugin gets out faster? Need support? Go to [link] (http://hobihut.com "hobihut.com") or [link] (http://immortaldc.com "hunt us down at corporate") and we'll be happy to help!
...
.5 - (2014-10-20) - updated code to WP 4.0, added domain info search, fixed plugin styles not loading, new features.
